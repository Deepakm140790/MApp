...
public class WomenFragment extends Fragment implements MainActivity.MainActivityInteractionListener,
        GridViewAdapter.ClickListener {
    private static final String TAG = "WomenFragment";
    private Context mContext;
    private RecyclerView mRecyclerView;
    private static final String DTAG = "DataTagWomen";
    ...
    private void init(View view) {
        mProgressBar = (ProgressBar) view.findViewById(R.id.pb_women);

        mRecyclerView = (RecyclerView) view.findViewById(R.id.rv_women);
